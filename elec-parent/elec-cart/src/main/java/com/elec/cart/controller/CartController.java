package com.elec.cart.controller;
...
public class CartController {
	...
	@ResponseBody
	public ElecResult update(@PathVariable long id,@PathVariable int num,HttpServletRequest req) {
	...
	@ResponseBody
	public ElecResult delete(@PathVariable long id,HttpServletRequest req) {
